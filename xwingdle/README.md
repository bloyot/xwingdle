...
* [`src/xwingdle/styles.cljs`](src/xwingdle/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/xwingdle/`](src/xwingdle/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/xwingdle/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `xwingdle` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/xwingdle/config.cljs) defaults to `true` in
...
```clj
(ns xwingdle.example
  (:require [xwingdle.config :as config])
